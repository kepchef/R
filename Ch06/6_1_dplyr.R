...
df_filter4 <- df_exam %>% select(science) %>% filter(science >= 60 & science < 80)
df_filter5 <- df_exam %>% select(everything()) %>% filter(english >= 60 | science < 80)
df_filter1
df_filter2
df_filter3
df_filter4
